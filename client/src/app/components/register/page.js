...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        clearForm()
        router.push("/components/customize")
    }
    ...
    return (
        ...
        items-center bg-[url('/signup_bg.jpg')]">
            ...
            backdrop-blur shadow-lg px-5 shadow-black flex flex-col items-center gap-5 p-5">
                ...
                {/* Name */}
                <input value={name} required type="text" placeholder="Enter your Name" onChange={(e) => setName(e.target.value)}
                ...
                <p className="text-white text-[18px]">Already have an account ?
                    <Link href="/components/signin" className="text-blue-400 cursor-pointer"> Sign In</Link>
                </p>
